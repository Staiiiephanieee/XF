...
class GameRenderData:
    def __init__(self):
        ...
        self.FONT = pg.font.Font(self.FONTS['DroidSans'], 14)
        ...
        self.atexts = AnimateText([
            ...
            {"text": ">>> USE \'LEFT\' or \'RIGHT\' key to choose the choice <<<",
             "x": 32 * 10,
             "y": 32 * 2,
             "type": "text"},

            {"text": ">>> They may also be used to go through the storyline if there is no choice provided <<<",
             "x": 32 * 6,
             "y": 32 * 2,
             "type": "text"},

            {"text": ">>> The choice looks like this:\" xxxxxxxxxx xx < > xxxxxxxxx x \"<<<",
             "x": 32 * 6,
             "y": 32 * 2,
             "type": "text"},
            ...
            {"text": "It is indeed quite crazy < > I believe you, dude.",
             "x": 32 * 14,
             "y": 32 * 14,
             "type": "button",
             "offset": 1},
            ...
            {"text": "Try the door! < > What\'s your staus?",
             "x": 32 * 14,
             "y": 32 * 14,
             "type": "button",
             "offset": 2},
            ...
            {"text": "My phone got...20% of the battery and that's the only thing that links us now.",
             "x": 32 * 0,
             "y": 32 * 13,
             "type": "text"},
            ...
            {"text": "Seriously? Again? I mean, how long have you been out, 6 days ? ",
             "x": 32 * 14,
             "y": 32 * 20,
             "type": "button",
             "offset": 1},
            ...
            {"text": "***********[CAUTION >>> Picture analyze failed #:no match]***********",
             "x": 32 * 8,
             "y": 32 * 26,
             "type": "button",
             "offset": 1},
            ...
            {"text": ">>>USE \'W\' \'A\' \'S\' \'D\' to control the character<<<",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
        ...
        self.btexts = AnimateText([
            ...
            {"text": " Go and ask for help! < > Hide yourself!",
             "x": 32 * 14,
             "y": 32 * 26,
             "type": "button",
             "offset": 7},
            ...
            {"text": "D-CN-6050, could you hear me?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "D-CN-6050, this is SCP Fundation. Are you having contact with other D Class?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "D-CN-6050,report the current situation on the stage.",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "D-CN-6050,What\'s the name of the King currently?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "Dude, you got to help me.They've got a gun!",
             "x": 32 * 0,
             "y": 32 * 26,
             "type": "text"},

            {"text": "Gonzalo < > Antonio",
             "x": 32 * 14,
             "y": 32 * 26,
             "type": "button",
             "offset": 2},
            ...
            {"text": "D-CN-6050,Who was Petruccio ?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},

            {"text": "He was a noble lord allied with Gonzalo < > He was Antonio\'s best friend",
             "x": 32 * 14,
             "y": 32 * 26,
             "type": "button",
             "offset": 2},

            {"text": "Thank you for your answer, D-CN-6050",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text",
             "offset": 6},
            ...
            {"text": "D-CN-6050,is there any abnormal phenomena on stage?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "D-CN-6050, Which ACT are you currently watching?",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "D-CN-6050 report what\'s happening.",
             "x": 32 * 6,
             "y": 32 * 26,
             "type": "text"},
            ...
            {"text": "Hurry and help them! < > No, Stand down!",
             "x": 32 * 14,
             "y": 32 * 26,
             "type": "button",
             "offset": 1},
            ...
            {"text": "Rush to the door! < > Run away from them!",
             "x": 32 * 14,
             "y": 32 * 26,
             "type": "button",
             "offset": 6},
