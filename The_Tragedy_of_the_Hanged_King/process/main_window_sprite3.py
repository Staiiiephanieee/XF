...
class Scripts(pg.sprite.Sprite):
    def __init__(self, imagepath, x, y):
        ...
        self.image = GFX[imagepath]
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y

    def update(self, level_surface):
        level_surface.blit(self.image, self.rect)
...
if __name__ == '__main__':
    ...
    script1 = Scripts('script1', 235, 32 * 9.5)
    script2 = Scripts('script2', 32 * 7, 32 * 15.6)
    ...
    while not done:
        ...
        script1.update(level_surface)
        script2.update(level_surface)
        ...
        if script_toggle:
            ...
            textpos.x = boxpos.x + 32
            textpos.y = boxpos.y + 32
